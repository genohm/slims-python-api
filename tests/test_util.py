...
class Test_Util(unittest.TestCase):
    ...
    def test_display_field_value_quantity_values(self):
        ...
        assert stringStream.getvalue().strip() == "None None 4.184 kJ None mm 6.02214076e+23 None"
    ...
    def test_display_field_value_date_values(self):
        ...
        assert stringStream.getvalue().strip() == str(datetimevalue) + " 2020-10-06 10:06"
    ...
    def test_display_field_value_date_nones(self):
        ...
        assert stringStream.getvalue().strip() == "None None None"
